...
const translations: Record<AppLanguage, TranslationSet> = {
  it: {
    ...
    dashboard: "Dashboard",
    shifts: "Turni",
    tasks: "Mansioni e bacheca",
    timelogs: "Timbrature",
    board: "Bacheca",
    requests: "Richieste e indisponibilita",
  ...
  en: {
    ...
    dashboard: "Dashboard",
    shifts: "Shifts",
    tasks: "Tasks and board",
    timelogs: "Time logs",
    board: "Board",
    requests: "Requests and availability",
  ...
  es: {
    ...
    dashboard: "Panel",
    shifts: "Turnos",
    tasks: "Tareas y tablon",
    timelogs: "Fichajes",
    board: "Tablon",
    requests: "Solicitudes y disponibilidad",
  ...
  fr: {
    ...
    shifts: "Plannings",
    tasks: "Taches et tableau",
    timelogs: "Pointages",
    board: "Tableau",
    requests: "Demandes et disponibilites",
