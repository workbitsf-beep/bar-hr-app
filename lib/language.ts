...
const runtimeEntries: RuntimeEntry[] = [
  ...
  ["Mansioni", { it: "Mansioni e bacheca", en: "Tasks and board", es: "Tareas y tablon", fr: "Taches et tableau" }],
  ["Timbrature", { it: "Timbrature", en: "Time logs", es: "Fichajes", fr: "Pointages" }],
  ["Bacheca", { it: "Bacheca", en: "Board", es: "Tablon", fr: "Tableau" }],
  ["Richieste", { it: "Richieste e indisponibilita", en: "Requests and availability", es: "Solicitudes y disponibilidad", fr: "Demandes et disponibilites" }],
  ...
  ["Ore reali", { it: "Ore reali", en: "Actual hours", es: "Horas reales", fr: "Heures reelles" }],
  ...
  ["MANAGER", { it: "Manager", en: "Manager", es: "Manager", fr: "Manager" }],
  ...
  ["Turno condiviso", { it: "Turno condiviso", en: "Shared shift", es: "Turno compartido", fr: "Planning partage" }],
  ...
  ["Rounding Rules", { it: "Regole di arrotondamento", en: "Rounding rules", es: "Reglas de redondeo", fr: "Regles d'arrondi" }],
  ...
  ["Move step by step. Every section saves directly to the database so you can leave and continue later.", { it: "Procedi passo dopo passo. Ogni sezione salva direttamente nel database, cosi puoi uscire e continuare piu tardi.", en: "Move step by step. Every section saves directly to the database so you can leave and continue later.", es: "Avanza paso a paso. Cada seccion guarda directamente en la base de datos para que puedas salir y continuar mas tarde.", fr: "Avancez etape par etape. Chaque section enregistre directement dans la base de donnees afin que vous puissiez reprendre plus tard." }],
  ...
  ["Set rounding rules", { it: "Imposta le regole di arrotondamento", en: "Set rounding rules", es: "Configurar las reglas de redondeo", fr: "Definir les regles d'arrondi" }],
  ["This step is optional. You can enable it now or leave it disabled and configure it later.", { it: "Questo passaggio e facoltativo. Puoi attivarlo ora oppure lasciarlo disattivato e configurarlo piu tardi.", en: "This step is optional. You can enable it now or leave it disabled and configure it later.", es: "Este paso es opcional. Puedes activarlo ahora o dejarlo desactivado y configurarlo mas tarde.", fr: "Cette etape est facultative. Vous pouvez l'activer maintenant ou la laisser desactivee et la configurer plus tard." }],
  ["Enable rounding", { it: "Attiva arrotondamento", en: "Enable rounding", es: "Activar redondeo", fr: "Activer l'arrondi" }],
  ["Rounding minutes", { it: "Minuti di arrotondamento", en: "Rounding minutes", es: "Minutos de redondeo", fr: "Minutes d'arrondi" }],
  ...
  ["Nearest", { it: "Piu vicino", en: "Nearest", es: "Mas cercano", fr: "Le plus proche" }],
  ...
  ["Finish onboarding now if you prefer to invite employees later from the dashboard.", { it: "Completa ora l'onboarding se preferisci invitare altri dipendenti piu tardi dalla dashboard.", en: "Finish onboarding now if you prefer to invite employees later from the dashboard.", es: "Termina ahora el onboarding si prefieres invitar empleados mas tarde desde el panel.", fr: "Terminez maintenant l'onboarding si vous preferez inviter les employes plus tard depuis le tableau de bord." }],
